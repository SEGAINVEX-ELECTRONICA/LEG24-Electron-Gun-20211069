...
/*=========================================================================
    I2C ADDRESS/BITS
    -----------------------------------------------------------------------*/
    //#define ADS1015_ADDRESS                 (0x48)    // 1001000 (ADDR = GND)
    #define ADS1015_ADDRESS                 (0x49)    // 1001001 (ADDR = VDD)
/*=========================================================================*/
...
/*=========================================================================
	...
	#define ADS1015_REG_CONFIG_DR_HIGH		(0x00C0)  // 3300 samples per second
...
protected:
 ...
 public:
  ...
  uint16_t  readADC_Contin(uint8_t channel);
